...
const weatherApi = {
    key: '46c76b87f1c070daa305da5183ffe0de', // Replace with your new API key
...
// Function for the classname of the weather icon
function getIconClass(weatherStatus, temperature) {
    if (temperature < 0) {
        return 'fas fa-snowflake'; // Show snowflake icon for negative temperatures
    }
    ...
    switch (weatherStatus) {
        ...
        default:
            return 'fas fa-question'; // Default icon for unknown status
    }
}
